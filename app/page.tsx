          ...
          <div className="text-center space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 text-center">
              <div className="space-y-2">
                <div className="mx-auto h-8 w-8 text-pink-500">❤️</div>
                <p className="text-sm font-medium">Unique Dates</p>
              </div>
              <div className="space-y-2">
                <div className="mx-auto h-8 w-8 text-purple-500">🔍</div>
                <p className="text-sm font-medium">Local Hosts</p>
              </div>
            </div>

            <div className="space-y-3">
              <Button onClick={() => setShowWelcome(false)} className="w-full bg-blue-600">
                Get Started
              </Button>
      ...
      <div className="p-3">
        <Card className="relative overflow-hidden w-full cursor-pointer">
          <div className="h-[400px] bg-gray-200 relative">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
              ...
              <div className="flex flex-wrap gap-1">
                <Badge className="bg-white/20 text-white text-xs">Coffee</Badge>
                <Badge className="bg-white/20 text-white text-xs">Casual</Badge>
                <Badge className="bg-white/20 text-white text-xs">Outdoor</Badge>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 flex justify-center gap-8 bg-white">
            <Button variant="outline" className="w-16 h-16 rounded-full border-2 border-gray-300">
              ✕
            </Button>
            <Button className="w-16 h-16 rounded-full bg-red-500">❤️</Button>
          </div>
        </Card>
      </div>
